 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://OrderService/", wsdlLocation = "http://localhost:8080/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://OrderService/", "OrderService");
    ...
    public OrderServiceImpl getOrderServicePort() {
        return super.getPort(new QName("http://OrderService/", "OrderServicePort"), OrderServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "OrderServicePort")
    public OrderServiceImpl getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://OrderService/", "OrderServicePort"), OrderServiceImpl.class, features);
    }
